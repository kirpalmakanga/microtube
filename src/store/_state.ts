...
import { initialState as playerInitialState, PlayerState } from './player/_state';
import { initialState as playlistsInitialState, PlaylistsState } from './playlists/_state';
import {
    initialState as playlistItemsInitialState,
    PlaylistItemsState
} from './playlist-items/_state';
import { ChannelState, initialState as channelInitialState } from './channel/_state';
import {
    initialState as subscriptionsInitialState,
    SubscriptionsState
} from './subscriptions/_state';
import { initialState as searchInitialState, SearchState } from './search/_state';
import {
    initialState as notificationsInitialState,
    NotificationState
} from './notifications/_state';
import { initialState as promptInitialState, PromptState } from './prompt/_state';
