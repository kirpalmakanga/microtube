  ...
  render() {
    ...
    return (
      <Fade className="dialog__overlay" onClick={close} in={isVisible}>
        <div className="dialog shadow--2dp" onClick={e => e.stopPropagation()}>
          ...
          {form ? (
            <div className="dialog__content">
              <ImportVideoForm id="importVideos" onSubmit={callback} />
            </div>
          ) : playlists.length ? (
            <div className="dialog__content">
              <PlaylistManager items={playlists} onClickItem={callback} />{' '}
            </div>
          ) : null}
          ...
          <footer className="dialog__actions">
            ...
            <Button
              ...
              onClick={form ? () => {} : playlists.length ? close : callback}
              title={confirmText}
            />
          </footer>
        </div>
