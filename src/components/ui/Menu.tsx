...
interface MenuProps {
    ...
    isVisible?: boolean;
    onClose?: () => void;
    children?: (openMenu: () => void) => JSXElement;
}
...
const Menu: Component<MenuProps> = (props) => {
    ...
    createEffect((previousIsVisible) => {
        if (props.isVisible !== previousIsVisible) {
        }
    ...
    return (
        <>
            ...
            <Modal title={props.title} isVisible={isMenuVisible()} onClickClose={closeMenu}>
