  ...
  return (
    <Route path='/' component={App}>
      <IndexRoute component={Playlists} />
       <Route path='/playlist/:id' component={PlaylistItems} onEnter={() => dispatch({ type: 'CLEAR_PLAYLIST_ITEMS' })}/>
       <Route path='/subscriptions' component={Subscriptions} />
       <Route path='/channel/:id' component={Channel} onEnter={() => dispatch({ type: 'CLEAR_CHANNEL_VIDEOS' })}/>
    </Route>
  )
}
