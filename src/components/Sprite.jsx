        ...
        return (
            <svg style={style}>
                ...
                <symbol id="icon-screen" viewBox="0 0 24 24">
                    <path d="M21 17.016v-12h-18v12h18zM21 3c1.078 0 2.016 0.891 2.016 2.016l-0.047 12c0 1.078-0.891 1.969-1.969 1.969h-5.016v2.016h-7.969v-2.016h-5.016c-1.125 0-2.016-0.891-2.016-1.969v-12c0-1.125 0.891-2.016 2.016-2.016h18z" />
                </symbol>
                ...
                <symbol id="icon-loading" viewBox="0 0 32 32">
                    <path className="rotating" style={{transformOrigin: '50% 50%'}} d="M16 0c-8.837 0-16 7.163-16 16s7.163 16 16 16 16-7.163 16-16-7.163-16-16-16zM16 8c4.418 0 8 3.582 8 8s-3.582 8-8 8-8-3.582-8-8 3.582-8 8-8zM25.546 25.546c-2.55 2.55-5.94 3.954-9.546 3.954s-6.996-1.404-9.546-3.954-3.954-5.94-3.954-9.546c0-3.606 1.404-6.996 3.954-9.546l2.121 2.121c0 0 0 0 0 0-4.094 4.094-4.094 10.755 0 14.849 1.983 1.983 4.62 3.075 7.425 3.075s5.441-1.092 7.425-3.075c4.094-4.094 4.094-10.755 0-14.849l2.121-2.121c2.55 2.55 3.954 5.94 3.954 9.546s-1.404 6.996-3.954 9.546z" />
                </symbol>
                ...
                <symbol id="icon-folder" viewBox="0 0 24 24">
                    <path d="M9.984 3.984l2.016 2.016h8.016c1.078 0 1.969 0.938 1.969 2.016v9.984c0 1.078-0.891 2.016-1.969 2.016h-16.031c-1.078 0-1.969-0.938-1.969-2.016v-12c0-1.078 0.891-2.016 1.969-2.016h6z" />
                </symbol>
