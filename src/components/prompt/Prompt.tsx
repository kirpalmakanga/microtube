        ...
        <>
            ...
            <Transition name="slide-up">
                <Show when={prompt.isVisible}>
                    ...
                    >
                        <div
                            class="bg-primary-900 shadow min-w-md max-w-full rounded p-4"
                        ...
                        >
                            ...
                            <Show when={isMode('import', 'playlists')}>
                                <div class="flex flex-col flex-grow overflow-y-auto border-primary-700">
                            ...
                            <Show when={prompt.cancelText || isMode('import') || isMode('default')}>
